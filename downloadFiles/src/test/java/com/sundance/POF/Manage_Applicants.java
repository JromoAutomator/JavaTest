...
public class Manage_Applicants extends webElements_Keywords{
	...
	public Manage_Applicants(WebDriver extdriver,int intTimeOut) {
		PageFactory.initElements(new AjaxElementLocatorFactory(extdriver,intTimeOut), this);
	}
	
	public Manage_Applicants(WebDriver extdriver) {
